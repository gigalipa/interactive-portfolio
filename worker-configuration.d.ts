/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 13e85f51ac17a55e004b2725ff6d1e37)
// Runtime types generated with workerd@1.20260730.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	CHAT_RATE_LIMITER: RateLimit;
	NOTION_TOKEN: string;
	GOOGLE_API_KEY_EMB: string;
	GOOGLE_API_KEY_LLM: string;
	GOOGLE_API_KEY_LIVE: string;
	CHROMA_HOST: string;
	CHROMA_API_KEY: string;
	CHROMA_TENANT: string;
	CHROMA_DATABASE: string;
	NOTION_KNOWLEDGE_BASE_DATA_SOURCE_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOTION_TOKEN" | "GOOGLE_API_KEY_EMB" | "GOOGLE_API_KEY_LLM" | "GOOGLE_API_KEY_LIVE" | "CHROMA_HOST" | "CHROMA_API_KEY" | "CHROMA_TENANT" | "CHROMA_DATABASE" | "NOTION_KNOWLEDGE_BASE_DATA_SOURCE_ID">> {}
}
