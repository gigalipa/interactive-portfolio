	...
	return (
		<div className={`flex ${isModel ? "justify-start" : "justify-end"}`}>
			<p
				...
				className={
					isModel
						? "border-electric-blue/60 bg-deep-blue/80 text-ion max-w-[80%] rounded-2xl rounded-bl-sm border px-4 py-2.5 text-left text-sm whitespace-pre-wrap backdrop-blur-lg"
